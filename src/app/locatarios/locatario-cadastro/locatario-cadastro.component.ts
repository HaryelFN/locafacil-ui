...
import { ImovelService } from 'src/app/imoveis/imovel.service';

@Component({
  selector: 'app-locatario-cadastro',
  templateUrl: './locatario-cadastro.component.html'
})
export class LocatarioCadastroComponent implements OnInit {
