...
@Component({
  selector: 'app-procurador-cadastro',
  templateUrl: './procurador-cadastro.component.html'
})
export class ProcuradorCadastroComponent implements OnInit {
